...
public class MathSet<E> extends java.util.HashSet<E> {
   ...
   public MathSet<E> copy() {
      MathSet<E> set = new MathSet<E>(this.size());
      for (E x : this) {
         set.add(x);
      }
      return set;
   ...
   public MathSet<E> minus(java.util.Set<E> minuend) {
      MathSet<E> s = new MathSet<E>(this.size());
      for (E x : this) {
         s.add(x);
      }
      s.removeAll(minuend);
   ...
   public static <E> ArrayList<MathSet<E>> subsets(java.util.Set<E> set, int k) {
      ArrayList<MathSet<E>> subsets = new ArrayList<MathSet<E>>();
      if (k == 0) {
      ...
      if (k == 1) {
         ...
         for (int i = 0; i < s.size(); i++) {
            tmpS = new MathSet<E>(); // size: Größe: n über k
   ...
   public static <E> ArrayList<MathSet<MathSet<E>>> partitions(MathSet<E> set) {
      ArrayList<MathSet<MathSet<E>>> partitions = new ArrayList<MathSet<MathSet<E>>>();
      ...
      int n, i;
      for (int[] p : pList) {
         partition = new ArrayList<MathSet<E>>();
         n = max(p);
         for (i = 0; i <= n; i++) {
         ...
         partitions.add(new MathSet<MathSet<E>>(partition));
      }
      return partitions;
   }
